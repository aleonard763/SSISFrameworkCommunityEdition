...
Declare @azureSqlDbName nvarchar(255) = N'' /*** ENTER AZURE SQL DB NAME ***/
Declare @azureSqlLogin nvarchar(128) = N'' /*** ENTER AZURE SQL Login ***/

 -- Framework\Parent.dtsx\CM.SSISDB.ConnectionString_0 Package Parameter Override
Declare @PackageParameter_CM_SSISDB_ConnectionString_0 sql_variant = N'Data Source=' + @azureSqlDbName + '.database.windows.net;User ID=' + @azureSqlLogin + ';Initial Catalog=SSISDB;Application Name=SSIS-Parent-SSISDB;'
 -- Framework\Parent.dtsx\CM.SSISDB.Password_1 Package Parameter Override
Declare @PackageParameter_CM_SSISDB_Password_1 sql_variant = N'' /*** ENTER AZURE SQL DB PASSWORD ***/
...
print ''
 ...
 -- Framework\Parent.dtsx\CM.SSISDB.Password Package Parameter Override
print 'Framework\Parent.dtsx\CM.SSISDB.Password Package Parameter Override'
print ' - Clear CM.SSISDB.Password Package Parameter Override or Reference'
Exec [SSISDB].[catalog].[clear_object_parameter_value] 
     @object_type = 30 -- package 
   , @object_name = N'Parent.dtsx' 
   , @parameter_name = N'CM.SSISDB.Password' 
   , @folder_name = N'Framework' 
   , @project_name = N'Framework' 
print ' - Framework\Parent.dtsx\CM.SSISDB.Password Package Parameter Override cleared'
print ''

print ' - Add or Update CM.SSISDB.Password Package Parameter Override'
Exec [SSISDB].[catalog].[set_object_parameter_value] 
     @object_type = 30 -- package 
   , @parameter_name = N'CM.SSISDB.Password' 
   , @object_name = N'Parent.dtsx' 
   , @folder_name = N'Framework' 
   , @project_name = N'Framework' 
   , @parameter_value = @PackageParameter_CM_SSISDB_Password_1
   , @value_type = 'V' 
print ' - Framework\Parent.dtsx\CM.SSISDB.Password Package Parameter Override added / updated'
print ''
